  ...
  if (isset($_POST['password']) && isset($_POST['email']) && isset($_POST['username']))
  {
    ...
    elseif($password == $confirmPassword)
    {
      ...
      else
      {
		...
		$userId = $dbo->createUser($username, $password, $email,$userType);
        if ($userId == -1)
...
<html>
    ...
    <body>
      ...
      <form class="form-register" action="" method="post">
		...
		Are you a music band ?
		<input type="radio" name="userType" value="BAND">Yes
		<input type="radio" name="userType" value="USER" checked = "true" >No
        <center>
		<br>
