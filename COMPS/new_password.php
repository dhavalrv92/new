		...
		<div>
			...
			<div id="middle">
				...
				<form name="new_pass" action="new_password?id=<?php echo $_GET['id']; ?>" method="POST" onsubmit="return(validate());">
					<table>
						<tr>
							<td style="border: 0px solid red" align="center">
								<font><font style="color: #FF0000;">* </font><b>New Password : </b></font>
							</td>
							<td style="border: 0px solid red" align="center">
						...
						<tr>
							<td style="border: 0px solid red" align="center">
								<font><font style="color: #FF0000;">* </font><b>Confirm New Password : </b></font>
							</td>
							<td style="border: 0px solid red" align="center">
						...
						<tr>
							<td style="border: 0px solid red" align="center" colspan="2">
