...
<?php
	...
	$g->select_command = "SELECT * FROM seminars WHERE id='$id'";
	...
	$col2 = array();
	$col2["title"] = "From Date"; // caption of column
	$col2["name"] = "date_from"; // grid column name, same as db field or alias from sql
	$col2["editable"] = TRUE;

	$col2 = array();
	$col2["title"] = "To Date"; // caption of column
	$col2["name"] = "date_to"; // grid column name, same as db field or alias from sql
	$col2["editable"] = TRUE;
	
	$col3 = array();
	$col3["title"] = "Name of Seminar"; // caption of column
	$col3["name"] = "name"; // grid column name, same as db field or alias from sql
	$col3["editable"] = TRUE;
	...
	$col5 = array();
	$col5["title"] = "Seminar Nature"; // caption of column
	$col5["name"] = "seminar_nature"; // grid column name, same as db field or alias from sql
	$col5["editable"] = TRUE;
