...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="CSS Files/standard.css" />
	...
	<body>
		...
		<div>
			...
			<div id="middle">
				...
				<form onsubmit="return (validate());" name="semselect" action="select_sem" method="POST">
					<center>
						<table id="input_tbl">
							<!--tr id="input">
								<td id="input">
					...
					if (isset($_POST['submit']))
					{
						...
						if ($submit)
						{
							if (isset($_POST['sem']))
							{
								...
								//echo $sem;
								echo '
									<form onsubmit="return (validate_year());" enctype="multipart/form-data" name="yearselect" action="upload_result" method="POST">
										<center>
											<table id="input_tbl">
												<tr id="input">
													<td id="input">
