<?php
	...
	if ( isset($_SESSION['assistant']) )
	{
		...
		$query = "SELECT * FROM stock_softwarelist";
...
<?php
	...
	$g->table = "kjscomp_stock.stock_softwarelist";
	
	// subqueries are also supported now (v1.2)
	$g->select_command = "SELECT * FROM kjscomp_stock.stock_softwarelist";
