...
<html>
	...
	<head>
		...
		<script language="JavaScript" type="text/javascript">  
			...
			{
				window.open("print_challan_details?lab_no="+val+"","_blank");
			}
			function validate()
			{
		...
		<div>
			...
			<div id="middle">
				<center>
					...
					<form onsubmit="return(validate());" action="print_challan_details" method="POST" name="stock_find" target="_blanck">
						<table id="input_tbl">
							<tr id="input">
								<td id="input">
