<?php
	...
	if ( isset($_SESSION['assistant']) )
	{
		...
		$query = "SELECT * FROM stock_furniturelist";
...
<?php
	...
	// set few params
	$grid["caption"] = "Furniture Details";
	...
	$g->table = "kjscomp_stock.stock_furniturelist";
	
	// subqueries are also supported now (v1.2)
	$g->select_command = "SELECT * FROM kjscomp_stock.stock_furniturelist";
