<?php
	...
	if ( isset($_SESSION['assistant']) )
	{
		...
		$query = "SELECT * FROM stock_part2list";
...
<?php
	...
	$g->table = "kjscomp_stock.stock_partlist";
	
	// subqueries are also supported now (v1.2)
	$g->select_command = "SELECT * FROM kjscomp_stock.stock_part2";
