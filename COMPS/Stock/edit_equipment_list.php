<?php
	...
	if ( isset($_SESSION['assistant']) )
	{
		...
		$query = "SELECT * FROM stock_equipmentlist";
...
<?php
	...
	// set few params
	$grid["caption"] = "Equipment Details";
	...
	$g->table = "kjscomp_stock.stock_equipmentlist";
	
	// subqueries are also supported now (v1.2)
	$g->select_command = "SELECT * FROM kjscomp_stock.stock_equipmentlist";
