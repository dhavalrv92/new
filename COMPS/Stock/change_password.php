...
<?php
	if (isset($_POST['submit']))
	{
		...
		if ($submit)
		{
			...
			$query="UPDATE kjscomp_stock.assistant_login SET password='" . $password . "' WHERE user_id=" . $id . "";
	...
	<body>
		...
		<div>
			...
			<div id="middle">
				...
				<form name="new_pass" action="change_password" method="POST" onsubmit="return(validate());">
					<table width="100%">
						<tr>
